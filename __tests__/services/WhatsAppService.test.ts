import { EvolutionWhatsAppService, WhatsAppService, WhatsAppResponse } from '../../app/services/WhatsAppService';
...
describe('EvolutionWhatsAppService', () => {
  ...
  describe('Constructor and Configuration', () => {
    ...
    it('should throw error when EVO_INSTANCE is missing', () => {
      ...
      expect(() => new EvolutionWhatsAppService()).toThrow('Evo API endpoint or key not configured.');
    });
  ...
  describe('Connectivity Tests', () => {
    it('should successfully connect to Evolution API', async () => {
      ...
      const result = await service.sendMessage('5511999999999', 'Connectivity test');
    ...
    it('should handle API timeout scenarios', async () => {
      ...
      const result = await service.sendMessage('5511999999999', 'Timeout test');
    ...
    it('should handle rate limiting (429 status)', async () => {
      ...
      const result = await service.sendMessage('5511999999999', 'Rate limit test');
