    ...
    <header className="w-full bg-secondary-background">
      <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mt-[8px] sm:mt-[12px] lg:mt-[16px] mr-[32px] sm:mr-[48px] lg:mr-[64px] ml-[35px] sm:ml-[52px] lg:ml-[70px]">
          ...
          {/* Navigation Menu */}
          <nav className={`${menuOpen ? 'block' : 'hidden'} lg:block absolute lg:relative top-full lg:top-auto left-0 lg:left-auto w-full lg:w-auto bg-secondary-background lg:bg-transparent shadow-lg lg:shadow-none z-50 lg:z-auto`}>
            <div className="flex flex-col lg:flex-row gap-4 lg:gap-[32px] justify-center items-center p-4 lg:p-0 w-full lg:w-auto">
              ...
              <div className="relative group w-full lg:w-auto">
                ...
                >
                  <span className="text-sm font-normal leading-sm text-header-text group-hover:text-primary-background" style={{ fontFamily: 'Inter' }}>
                    Mais Opções
                  </span>
                  <Image
                ...
                {/* Submenu */}
                <ul role="menu" className="hidden group-hover:block absolute top-full left-0 bg-secondary-background shadow-lg rounded-sm mt-1 min-w-[200px] z-10">
                  <li role="menuitem" className="px-4 py-2 hover:bg-background-overlay-light cursor-pointer">
                    <span className="text-xs font-normal leading-xs text-header-text" style={{ fontFamily: 'Inter' }}>Opção 1</span>
                  </li>
                  <li role="menuitem" className="px-4 py-2 hover:bg-background-overlay-light cursor-pointer">
                    <span className="text-xs font-normal leading-xs text-header-text" style={{ fontFamily: 'Inter' }}>Opção 2</span>
                  </li>
                  <li role="menuitem" className="px-4 py-2 hover:bg-background-overlay-light cursor-pointer">
                    <span className="text-xs font-normal leading-xs text-header-text" style={{ fontFamily: 'Inter' }}>Opção 3</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          {/* Action Buttons */}
          <div className={`${menuOpen ? 'block' : 'hidden'} lg:block absolute lg:relative top-full lg:top-auto right-0 lg:right-auto w-full lg:w-auto bg-secondary-background lg:bg-transparent shadow-lg lg:shadow-none z-40 lg:z-auto mt-0 lg:mt-0`}>
            <div className="flex flex-col lg:flex-row gap-4 lg:gap-[16px] justify-center items-center p-4 lg:p-0 w-full lg:w-auto">
              ...
              <div className="flex justify-center items-center w-full lg:w-auto bg-primary-background rounded-sm shadow-[0px_1px_2px_#0700000c] pt-[8px] pr-[8px] pb-[8px] pl-[8px]">
                <span className="text-sm font-medium leading-sm text-left text-button-primary-text" style={{ fontFamily: 'Inter' }}>
                  Acessar
                </span>
              </div>
            </div>
