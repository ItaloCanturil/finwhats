...
const buttonClasses = cva(
  'inline-flex items-center justify-center font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed',
  {
    variants: {
      variant: {
        primary: 'bg-button-primary-background text-button-primary-text hover:bg-primary-background/90 focus:ring-primary-background',
        secondary: 'bg-button-secondary-background text-button-secondary-text hover:bg-background-overlay-medium focus:ring-background-overlay-medium',
        outline: 'border-2 border-primary-background text-primary-background bg-transparent hover:bg-primary-background/10 focus:ring-primary-background',
