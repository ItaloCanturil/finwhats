				...
				<div className="flex flex-col gap-[40px] sm:gap-[60px] lg:gap-[80px] justify-start items-center w-full">
					<div className="flex flex-col gap-4 lg:gap-[16px] justify-start items-center w-full max-w-[768px] mx-auto">
						<div className="flex justify-center items-center w-auto">
							<span
								className="text-sm font-semibold leading-sm text-center text-primary-text"
						...
						<div className="flex flex-col gap-4 sm:gap-6 lg:gap-[22px] justify-start items-center w-full">
							<h2
								className="text-[26px] sm:text-[39px] lg:text-3xl font-medium leading-[31px] sm:leading-[47px] lg:leading-5xl text-center text-primary-text w-full"
								style={{ fontFamily: "Manrope" }}
							>
								Descubra as funcionalidades do Zaza
							</h2>
							<p
								className="text-md font-normal leading-xl text-center text-primary-text w-full"
								style={{ fontFamily: "Inter" }}
							>
								Zaza é o seu assistente pessoal no WhatsApp, projetado para
								facilitar sua vida. Organize suas finanças e compromissos de
						...
						<div className="flex flex-col gap-8 sm:gap-12 lg:gap-[64px] justify-start items-center w-full lg:flex-1">
							<div className="flex flex-col gap-6 lg:gap-[24px] justify-start items-center w-full">
								...
								<div className="flex flex-col gap-4 lg:gap-[16px] justify-start items-center w-full">
									<h3
										className="text-xl font-medium leading-3xl text-center text-primary-text"
										style={{ fontFamily: "Manrope" }}
									>
										Organização Financeira
									</h3>
									<p
										className="text-sm font-normal leading-lg text-center text-primary-text w-full"
										style={{ fontFamily: "Inter" }}
									>
										Monitore seus gastos e saldo de forma prática e rápida pelo
										WhatsApp.
									</p>
								</div>
							</div>
							...
							<div className="flex flex-col gap-6 lg:gap-[24px] justify-start items-center w-full">
								...
								<div className="flex flex-col gap-3 sm:gap-4 lg:gap-[14px] justify-start items-center w-full">
									<h3
										className="text-xl font-medium leading-3xl text-center text-primary-text w-full"
										style={{ fontFamily: "Manrope" }}
									>
									...
									<p
										...
										style={{ fontFamily: "Inter" }}
									>
										Agende lembretes e compromissos diretamente no Google
										Calendar com facilidade.
									</p>
								</div>
							</div>
						</div>
						...
						<div className="flex flex-col gap-8 sm:gap-12 lg:gap-[64px] justify-start items-center w-full lg:flex-1">
							<div className="flex flex-col gap-6 lg:gap-[24px] justify-start items-center w-full">
								...
								<div className="flex flex-col gap-3 sm:gap-4 lg:gap-[14px] justify-start items-center w-full">
									...
									<p
										...
										style={{ fontFamily: "Inter" }}
									>
										Organize suas tarefas pessoais e nunca perca um prazo
										importante.
									</p>
								</div>
							</div>
							...
							<div className="flex flex-col gap-4 lg:gap-[16px] justify-start items-center w-full">
								...
								<p
									...
									style={{ fontFamily: "Inter" }}
								>
									Transforme sua rotina com a ajuda do Zaza, seu assistente
									pessoal inteligente.
								</p>
							</div>
						</div>
