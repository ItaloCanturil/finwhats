...
const CTASection = () => {
  const handleExperimente = () => {
    ...
    window.open('https://wa.me/your-whatsapp-number?text=Quero%20experimentar%20o%20Zaza', '_blank')
  }
        ...
        <div className="w-full max-w-[1440px] mx-auto">
          <div className="flex flex-col gap-6 sm:gap-8 lg:gap-[30px] justify-center items-center w-full">
            <div className="flex flex-col gap-2 lg:gap-[8px] justify-start items-start w-auto">
              <h2 className="text-[26px] sm:text-[39px] lg:text-3xl font-medium leading-[36px] sm:leading-[54px] lg:leading-6xl text-left text-secondary-text" style={{ fontFamily: 'Manrope' }}>
                Descubra a Zaza Hoje
              </h2>
              <p className="text-md font-normal leading-md text-left text-secondary-text" style={{ fontFamily: 'Inter' }}>
                Experimente a Zaza e transforme sua forma de gerenciar tarefas diárias com facilidade.
              </p>
            </div>
